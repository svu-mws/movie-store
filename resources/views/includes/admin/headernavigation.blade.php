            ...
            <ul class="navbar-nav float-right">
              ...
              -->
                ...
                @if(Auth::user()->admin== true)
                    ...
                    <a href="{{route('uploadmovie')}}" class="btn btn-primary">upload movie</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated">
                        <a class="dropdown-item" href="{{route('userprofile')}}"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
                        <!--
                    ...
                    <a class="dropdown-item" onclick="document.getElementById('logoutform').submit();" href="javascript:void(0)"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>

                      <!-- <a class="nav-link"  onclick="document.getElementById('logoutform').submit();" href= "#">logout</a> -->
