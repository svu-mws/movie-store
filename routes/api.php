...
Route::get('actor/upload',"Admincontroller@addnewactors")->name('addnewactors');
Route::post('actor/upload',"Admincontroller@addnewactors1")->name('addnewactorspost');
            ...
            Route::get('actors/edit/{id}',"Admincontroller@editactor")->name('Admineditactor');
              ...
              Route::get('producers',"Admincontroller@producers")->name('Adminproducers');
                  Route::get('producers/edit/{id}',"Admincontroller@editproducer")->name('Admineditproducer');
                    ...
                    Route::get('type/upload',"Admincontroller@addnewtype")->name('addnewtype');
                    Route::post('type/upload',"Admincontroller@addnewtype1")->name('addnewtypepost');
